...
public class Sprite {
    ...
    {
        Paint p = new Paint();
        Rect destination = new Rect((int)x, (int)y, (int)(x + frameWidth*scale), (int)(y + frameHeight*scale));
        canvas.drawBitmap(bitmap, frames.get(currentFrame), destination,  p);
    }

    public Rect getBoundingBoxRect () {
        return new Rect((int)x+2*padding, (int)y+2*padding, (int)(x + frameWidth*scale - 2*padding), (int)(y + frameHeight*scale - 2*padding));
    }
